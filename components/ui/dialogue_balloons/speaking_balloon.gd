...
@onready var temporary_game_states: Array = []

## See if we are waiting for the player
@onready var is_waiting_for_input: bool = false:
	set(value):
		is_waiting_for_input = value
		next_indicator.visible = value

## See if we are running a long mutation and should hide the balloon
@onready var will_hide_balloon: bool = false
